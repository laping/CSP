...
class PeripheriqueController extends AbstractController
{
     ...
     * @IsGranted("ROLE_ADMIN")
     */
    public function editer(Peripherique $peripherique,Request $request, ObjectManager $manager){
     ...
     * @IsGranted("ROLE_ADMIN")
     */
    public function supprimer(Peripherique $peripherique, ObjectManager $manager){
